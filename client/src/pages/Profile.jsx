...
import {  updateUserFailure, updateUserSuccess, updateUserStart, deleteUserFailure,
  deleteUserSuccess, deleteUserStart } from '../redux/user/userSlice'; 
...
export default function Profile() {
  ...
  const handleFileUpload = (file) => {
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => setFormData({ ...formData, avatar: 
          downloadURL })
        );
        }
      );
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        { fileUploadErr ? (
         <span className='text-red-700'>Error imgae upload (Image must be less than 2 mb)
